...
<body class="bg-white text-slate-900 antialiased flex flex-col min-h-screen">
  ...
  <!-- UTILITY TOP BAR (Clean, Un-cramped on Mobile) -->
  <div class="bg-slate-900 text-slate-300 text-xs py-2 px-3 sm:px-4 border-b border-slate-800 relative z-20">
    <div class="max-w-7xl mx-auto flex justify-between items-center gap-2 sm:gap-3">
      ...
      <!-- Left: Contact info (Hidden on small mobile to avoid cramped header) -->
      ...
      <!-- Mobile Left Brand Indicator -->
      <div class="md:hidden flex items-center gap-1.5 text-slate-400 text-[11px]">
        <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
        <span class="font-medium text-slate-300">Admissions 2025-26 Open</span>
      </div>

      <!-- Right Actions: Language Switch & Portals -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 sm:h-20 gap-4">
        ...
        <a href="/index.php" class="flex items-center gap-3 group flex-shrink-0">
          <img src="<?php echo SITE_URL; ?>/assets/images/round_logo.png" alt="Tirumala Academy Emblem" width="48" height="48" class="w-10 h-10 sm:w-12 sm:h-12 object-contain transition-transform group-hover:scale-105">
  ...
  <div id="mobile-drawer">
    ...
    <div class="p-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70">
      <div class="flex items-center gap-2.5">
        <img src="<?php echo SITE_URL; ?>/assets/images/round_logo.png" alt="Logo" class="w-9 h-9 object-contain">
        <div>
      ...
      <button id="mobile-menu-close" class="p-2 rounded-lg text-slate-400 hover:text-slate-900 hover:bg-slate-200/60 transition" aria-label="Close Menu">
    ...
    <div class="p-3 bg-white border-b border-slate-100">
      <button type="button" class="search-trigger-btn w-full bg-slate-100 hover:bg-slate-200/80 text-slate-600 rounded-xl px-3.5 py-2.5 text-xs flex items-center justify-between transition">
        <span class="flex items-center gap-2">
          ...
          <span>Search rankers, papers, campuses...</span>
        </span>
    ...
    <div class="p-4 flex-1 overflow-y-auto space-y-1 text-slate-700">
      <a href="/index.php" class="flex items-center gap-2.5 py-2.5 px-3 rounded-xl font-semibold hover:bg-blue-50 hover:text-blue-700 transition">
      ...
      <a href="/about.php" class="flex items-center gap-2.5 py-2.5 px-3 rounded-xl font-semibold hover:bg-blue-50 hover:text-blue-700 transition">
        <svg class="w-4 h-4 text-slate-400" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"/></svg>
        <span>About Us & Leadership</span>
      </a>
      <a href="/results.php" class="flex items-center gap-2.5 py-2.5 px-3 rounded-xl font-semibold hover:bg-blue-50 hover:text-blue-700 transition">
      ...
      <a href="/facilities/transport.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">🚌 Transport & GPS Tracking</a>
      <a href="/facilities/hostel.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">🏢 A/C Hostel & Nutritious Dining</a>
      <a href="/facilities/computer-lab.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">💻 Online CBT Computer Lab</a>

      <div class="pt-3 pb-1 text-[11px] font-bold uppercase tracking-wider text-slate-400 px-3">Resources & Media</div>
      <a href="/model-papers.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">📄 Model Papers (Free PDF)</a>
      <a href="/gallery.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">🖼️ Campus Photo Gallery</a>

      <div class="pt-3 pb-1 text-[11px] font-bold uppercase tracking-wider text-slate-400 px-3">Locations & Portals</div>
      <a href="/contact.php" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50 hover:text-blue-700">📍 Campuses & Google Maps</a>
      ...
      <a href="/admin" class="block py-2 px-3 pl-8 rounded-lg text-sm text-slate-600 hover:bg-slate-50">⚙️ Staff / Admin Login</a>
